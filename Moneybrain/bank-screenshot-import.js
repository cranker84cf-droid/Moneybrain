...
function suspiciousScreenshotAmount(amount,merchant){if(/^\\d{1,2}:\\d{2}|ZWO|AktivKonto/i.test(merchant))return true;if(/AOK Niedersachsen/i.test(merchant))return false;if(/kwg|Kreiswohnbau/i.test(merchant)&&amount.value<=1000)return false;return !amount.explicitSign||(amount.value>=700&&amount.value<800)}
