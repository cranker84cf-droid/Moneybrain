const CACHE='moneybrain-v29',ASSETS=['./','index.html','styles.css','app.js','manifest.webmanifest','icon.svg','statement-import.js','vendor/pdf.min.mjs','vendor/pdf.worker.min.mjs','receipt-import.js','bank-screenshot-import.js','vendor/tesseract.min.js','vendor/tesseract-worker.min.js'];
