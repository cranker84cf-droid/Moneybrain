const CACHE='moneybrain-v35',ASSETS=['./','index.html','styles.css','app.js','manifest.webmanifest','icon.svg','statement-import.js','vendor/pdf.min.mjs','vendor/pdf.worker.min.mjs','receipt-import.js','vendor/tesseract.min.js','vendor/tesseract-worker.min.js'];
