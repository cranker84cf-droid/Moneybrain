const CACHE='moneybrain-v47',ASSETS=['./','index.html','styles.css','app.js','supabase-config.js','cloud-sync.js','manifest.webmanifest','icon.svg','statement-import.js','vendor/pdf.min.mjs','vendor/pdf.worker.min.mjs','receipt-import.js','paypal-import.js','vendor/tesseract.min.js','vendor/tesseract-worker.min.js'];
