const CACHE='moneybrain-v4',ASSETS=['./','index.html','styles.css','app.js','manifest.webmanifest','icon.svg','statement-import.js','vendor/pdf.min.mjs','vendor/pdf.worker.min.mjs'];
