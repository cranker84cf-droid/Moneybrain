const CACHE='moneybrain-v64',ASSETS=['./','index.html','styles.css','app.js','money-movements.js','money-accounts.js','supabase-config.js','cloud-sync.js','manifest.webmanifest','moneybrain-logo.png','moneybrain-icon-192.png','moneybrain-icon-512.png','moneybrain-icon-maskable-512.png','statement-import.js','vendor/pdf.min.mjs','vendor/pdf.worker.min.mjs','receipt-import.js','paypal-import.js','vendor/tesseract.min.js','vendor/tesseract-worker.min.js'];
